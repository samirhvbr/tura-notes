...
|---|---|
| [ACCEPTANCE-0.1d.md](ACCEPTANCE-0.1d.md) | **Milestone 0.1d's acceptance — the interface** — sixteen areas nobody has ticked, the narrow automated half that is honest about being narrow, and the twenty-six flows of 0.1b and 0.1c re-indexed with their steps rewritten for the window that now exists. |
