...
- 🔒 R8-04 — **tirar o `continue-on-error` da perna Windows do crash loop** quando ela passar dez noites seguidas (`gh run list --workflow crash.yml`, conferir o job `windows-latest`, nao a run). 24/09: 1 de 10. Espera tempo, nao decisao
