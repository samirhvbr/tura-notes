...
- 🔒 R8-03 — **o feed Linux segue master?** O app instalado so recebe o que esta no feed, e o feed so anda quando o dono roda `build-linux.sh --publish` (1.8.21 ate 24/09 13:43; o dono rodou o publish nessa hora e o feed Linux foi para 1.8.58, medido de fora as 13:50 — o que resolve o 1.8.21 de arvore suja). Pergunta `q_publish_linux`: o loop pode rodar o publish Linux de um worktree limpo a cada minor? A pergunta continua valendo para as proximas versoes
