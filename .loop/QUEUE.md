...
- 🔒 R8-02 — **atualizacao automatica** (pedido do dono, 24/09). Reverte parte do ADR-074 ("instalacao explicita depois do fechamento normal do workspace"), entao e ADR nova e pergunta `q_autoupdate` no quadro: baixar em segundo plano e instalar ao fechar o app (recomendado), instalar e reiniciar sozinho, ou manter como esta
